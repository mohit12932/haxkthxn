...
const Page = () => {
  ...
  return (
    <div className="bg-[#FFFDF6] bg-cover bg-no-repeat h-screen  flex justify-center items-center">
      <div className="w-full h-auto max-w-72 sm:max-w-sm py-6 sm:py-12 sm:px-6  mx-auto  border- border-black  rounded-lg shadow-md ">
    <div className="container  flex items-baseline justify-center h-auto px-6 mx-auto">
        <form className="w-full max-w-md"onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-center mt-6">
                ...
                ' text-black font-medium text-center capitalize border-b-2 border-blue-400">
                    sign in
                </a>
        ...
        <select  {...register("userOption", { required: "Please select an option" })}
          className="block w-full px-4 py-2 border rounded-lg bg-transparent focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
        >
