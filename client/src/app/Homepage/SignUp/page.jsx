    ...
    <div className="container  flex items-baseline justify-center h-auto px-6 mx-auto">
        <form className="w-full max-w-md"onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-center mt-6">
                ...
                ' text-black font-medium text-center capitalize border-b-3 ">
                    sign in
                </a>
                
                <a href="./SignUp" className="w-1/3 pb-2  text-black font-medium text-center capitalize border-b border-[#A0C878]">
                    sign up
                </a>
            </div>
...
(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"  fill="none">
    ...
    <p className="mt-8 text-xs text-gray-800 font-light text-center"> Don&apos;t have an account? <a href="./SignUp" className="font-medium text-blue-500 hover:underline">Register</a></p>
